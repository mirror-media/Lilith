...
// TODO: 添加auth的type definition以消除ts的報錯（下方為type位置參考）
// (目前皆以any作為替代)
import {
  ListAccessControl,
  BaseListTypeInfo,
...
// TODO: 完成owner
export const owner = async (auth: any) => {
  //   const user = auth?.session?.data
