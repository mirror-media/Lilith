...
const listConfigurations = list({
  fields: {
    person: relationship({
      label: '候選人-選舉',
      many: false,
      ref: 'PersonElection.editingPolitics',
    }),
    ...
    positionChange: relationship({
      ...
      ref: 'PoliticPositionChange.editingPolitic',
    }),
    factCheck: relationship({
      ...
      ref: 'PoliticFactCheck.editingPolitic',
    }),
    expertPoint: relationship({
      label: '專家觀點',
      many: true,
      ref: 'PoliticExpert.editingPolitic',
      ui: {
        displayMode: 'cards',
        linkToItem: true,
        cardFields: [
    ...
    repeat: relationship({
      label: '重複政見',
      many: true,
      ref: 'PoliticRepeat.editingPolitic',
      ui: {
        displayMode: 'cards',
        linkToItem: true,
    ...
    controversies: relationship({
      label: '爭議內容',
      many: true,
      ref: 'PoliticControversie.editingPolitic',
      ui: {
        displayMode: 'cards',
        linkToItem: true,
    ...
    response: relationship({
      label: '政見回應',
      many: true,
      ref: 'PoliticResponse.editingPolitic',
      ui: {
        displayMode: 'cards',
        linkToItem: true,
        cardFields: [
    ...
    timeline: relationship({
      label: '時間軸',
      many: true,
      ref: 'PoliticTimeline.editingPolitic',
    }),
    status: select({
      options: [
