...
CREATE TABLE "Person" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL DEFAULT E'',
    "alternative" TEXT NOT NULL DEFAULT E'',
    "other_names" TEXT NOT NULL DEFAULT E'',
    "email" TEXT NOT NULL DEFAULT E'',
    "gender" TEXT,
    ...
    "biography" TEXT NOT NULL DEFAULT E'',
    "national_identity" TEXT NOT NULL DEFAULT E'',
    "contact_details" TEXT NOT NULL DEFAULT E'',
    "links" TEXT NOT NULL DEFAULT E'',
...
CREATE TABLE "Organization" (
    ...
    "identifiers" TEXT NOT NULL DEFAULT E'',
    "classification" TEXT,
    "abstract" TEXT NOT NULL DEFAULT E'',
    "description" TEXT NOT NULL DEFAULT E'',
