...
ADD COLUMN     "relatedsThree" INTEGER,
...
-- CreateIndex
CREATE INDEX "Post_relatedsThree_idx" ON "Post"("relatedsThree");
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_relatedsThree_fkey" FOREIGN KEY ("relatedsThree") REFERENCES "Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;
