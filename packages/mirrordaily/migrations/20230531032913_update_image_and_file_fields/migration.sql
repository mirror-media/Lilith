/*
  ...
  - You are about to drop the column `pdfFile_mode` on the `Magazine` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Magazine" DROP COLUMN "pdfFile_mode";
