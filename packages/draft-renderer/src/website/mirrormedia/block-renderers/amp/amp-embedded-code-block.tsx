...
export default function AmpEmbeddedCodeBlock({
  ...
  function convertIframesToAmp(embeddedCode) {
    ...
    //       ?.replace('allowfullscreen="true"', 'allow="fullscreen"')
    //       .replace('allowtransparency="true"', 'allowtransparency')
  ...
  return (
    <div>
      <div
        dangerouslySetInnerHTML={{ __html: convertIframesToAmp(embeddedCode) }}
      />
