...
export type EnumNullableFilter<Enum extends graphql.EnumType<any>> =
...
export type EnumFilter<Enum extends graphql.EnumType<any>> =
  graphql.InputObjectType<{
    equals: graphql.Arg<Enum>
    in: graphql.Arg<graphql.ListType<graphql.NonNullType<Enum>>>
    notIn: graphql.Arg<graphql.ListType<graphql.NonNullType<Enum>>>
...
type EnumNullableListFilterType<Enum extends graphql.EnumType<any>> =
  graphql.InputObjectType<{
    // can be null
