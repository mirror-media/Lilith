...
const StringNullableListFilter: StringNullableListFilterType =
  graphql.inputObject({
...
type BoolNullableListFilterType = graphql.InputObjectType<{
  // can be null
  equals: graphql.Arg<
    graphql.ListType<graphql.NonNullType<typeof graphql.Boolean>>
  >
  // can be null
...
const BoolNullableListFilter: BoolNullableListFilterType = graphql.inputObject({
  ...
  fields: () => ({
    // can be null
    equals: graphql.arg({
      type: graphql.list(graphql.nonNull(graphql.Boolean)),
    }),
    // can be null
...
type IntNullableListFilterType = graphql.InputObjectType<{
  ...
  hasEvery: graphql.Arg<
    graphql.ListType<graphql.NonNullType<typeof graphql.Int>>
  >
  hasSome: graphql.Arg<
    graphql.ListType<graphql.NonNullType<typeof graphql.Int>>
  >
...
const FloatNullableListFilter: FloatNullableListFilterType =
  graphql.inputObject({
    name: 'CustomFloatNullableListFilter',
    fields: () => ({
      // can be null
      equals: graphql.arg({
        type: graphql.list(graphql.nonNull(graphql.Float)),
      }),
      // can be null
...
const DateTimeNullableListFilter: DateTimeNullableListFilterType =
  graphql.inputObject({
...
const DecimalNullableListFilter: DecimalNullableListFilterType =
  graphql.inputObject({
...
const BigIntNullableListFilter: BigIntNullableListFilterType =
  graphql.inputObject({
    name: 'CustomBigIntNullableListFilter',
    fields: () => ({
      // can be null
      equals: graphql.arg({
        type: graphql.list(graphql.nonNull(graphql.BigInt)),
      }),
      // can be null
