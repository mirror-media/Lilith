...
import { FieldControllerConfig } from '@keystone-6/core/types'
import { controller, CustomTimestampFieldMeta } from '../index'
const STUBCONFIG: FieldControllerConfig<CustomTimestampFieldMeta> = {
  listKey: 'timestamp',
  path: './timestamp',
  label: 'timestmap',
  customViews: {},
