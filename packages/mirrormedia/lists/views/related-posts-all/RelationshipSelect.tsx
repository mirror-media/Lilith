...
export const RelationshipSelect = ({
  ...
  > = gql`
    query RelationshipSelectAllPosts($where: JSON, $take: Int!, $skip: Int!, $orderBy: JSON) {
      items: allPostsForRelation(where: $where, take: $take, skip: $skip, orderBy: $orderBy) {
        ${idFieldAlias}: id
        ${labelFieldAlias}: ${labelField}
        ${extraSelection}
      }
      count: allPostsForRelationCount(where: $where)
    }
  `
  ...
  useIntersectionObserver(
    ([{ isIntersecting }]) => {
      ...
      if (
        ...
        > = gql`
              query RelationshipSelectAllPostsMore($where: JSON, $take: Int!, $skip: Int!, $orderBy: JSON) {
                items: allPostsForRelation(where: $where, take: $take, skip: $skip, orderBy: $orderBy) {
                  ${labelFieldAlias}: ${labelField}
                  ${idFieldAlias}: id
                  ${extraSelection}
